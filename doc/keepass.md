...
The following new options are available for beetokd and beetok-qt:
...
The following rpc commands are available:
 ...
 - _keepass init_: sets up the association between beetokd and keepass by generating an AES key and sending an association message to KeePassHttp. This will trigger KeePass to ask for an Id for the association. Returns the association and the base64 encoded string for the AES key.
...
Sample initialization flow from _beetok-qt_ console (this needs to be done only once to set up the association):
 ...
 - You should get a response like this "_Association successful. Id: mydrkwalletbeetok - Key: AgQkcs6cI7v9tlSYKjG/+s8wJrGALHl3jLosJpPLzUE=_"
 - Edit _beetok.conf_ and fill in these values
```
keepass=1
