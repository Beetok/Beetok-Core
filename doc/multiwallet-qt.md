...
In order to support loading of multiple wallets in beetok-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is beetok.cpp.
...
Changes to beetok.cpp
----------------------
beetok.cpp is the entry point into beetok-qt, and as such, will require some minor modifications to provide hooks for
