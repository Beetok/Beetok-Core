...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Beetok Core beetok-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  beetok-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded beetok transaction") + "\n" +
                               "  beetok-tx [options] -create [commands]   " + _("Create hex-encoded beetok transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded beetok transaction
