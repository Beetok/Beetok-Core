                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Beetok Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Beetok address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and beetok: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Beetok Core"), this);
    aboutAction->setStatusTip(tr("Show information about Beetok Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Beetok"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Beetok addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Beetok addresses"));
    ...
    openAction->setStatusTip(tr("Open a Beetok: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Beetok Core help message to get a list with possible Beetok command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Beetok Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Beetok network", "", count));
}
...
{
    QString strTitle = tr("Beetok Core"); // default title
