...
/** Utility functions used by the Beetok Qt UI.
 */
namespace GUIUtil
{
...
// Render Beetok addresses in monospace font
...
// Parse "beetok:" URI into recipient object, return true on successful parsing
