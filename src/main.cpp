...
int64_t GetBlockValue(int nHeight)
        {
			...
			else if (nHeight < 60000) { nSubsidy = 1 * COIN; }
			else if (nHeight < 90000) { nSubsidy = 1.25 * COIN; }
			else if (nHeight < 120000) { nSubsidy = 1.5 * COIN; }
			else if (nHeight < 150000) { nSubsidy = 1.75 * COIN; }
			else if (nHeight < 180000) { nSubsidy = 2 * COIN; }
			else if (nHeight < 210000) { nSubsidy = 2.25 * COIN; }
			else if (nHeight < 240000) { nSubsidy = 2.5 * COIN; }
			else if (nHeight < 270000) { nSubsidy = 2.75 * COIN; }
			else if (nHeight < 300000) { nSubsidy = 3 * COIN; }
			else if (nHeight < 330000) { nSubsidy = 3.25 * COIN; }
			else if (nHeight < 360000) { nSubsidy = 3.5 * COIN; }
			else if (nHeight < 390000) { nSubsidy = 3.75 * COIN; }
			else if (nHeight < 420000) { nSubsidy = 4 * COIN; }
			else if (nHeight < 450000) { nSubsidy = 4.25 * COIN; }
			else if (nHeight < 480000) { nSubsidy = 4.5 * COIN; }
			else if (nHeight < 510000) { nSubsidy = 4.75 * COIN; }
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
	...
	else if (nHeight < 90000) { ret = blockValue * 0.9075; }
	else if (nHeight < 120000) { ret = blockValue * 0.91; }
	else if (nHeight < 150000) { ret = blockValue * 0.9125; }
	else if (nHeight < 180000) { ret = blockValue * 0.915; }
	else if (nHeight < 210000) { ret = blockValue * 0.9175; }
	else if (nHeight < 240000) { ret = blockValue * 0.92; }
	else if (nHeight < 270000) { ret = blockValue * 0.9225; }
	else if (nHeight < 300000) { ret = blockValue * 0.925; }
	else if (nHeight < 330000) { ret = blockValue * 0.9275; }
	else if (nHeight < 360000) { ret = blockValue * 0.93; }
	else if (nHeight < 390000) { ret = blockValue * 0.9325; }
	else if (nHeight < 420000) { ret = blockValue * 0.935; }
	else if (nHeight < 450000) { ret = blockValue * 0.9375; }
	else if (nHeight < 480000) { ret = blockValue * 0.94; }
	else if (nHeight < 510000) { ret = blockValue * 0.945; }
	else if (nHeight > 510000) { ret = blockValue * 0.95; }
	return ret;
}
