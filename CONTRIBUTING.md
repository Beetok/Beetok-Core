Contributing to Beetok Core
============================

The Beetok Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Beetok Core project, and is not to be
confused with overall Beetok Network Protocol consensus changes.

Whether a pull request is merged into Beetok Core rests with the project merge
...
Patches that change Beetok consensus rules are considerably more involved than
...
Where a patch set proposes to change the Beetok consensus, it must have been
...
The project leader is the release manager for each Beetok Core release.
